            ...
            foreach ($usuarios as $usuario): ?>
                <div class="usuario">
                    ...
                    <div class="botones">
                        ...
                        <?php
                        if($usuario["blocked"]):?>
                            <form method="post" action="IndexUsuarios-administrador.php?action=unblock" onsubmit="return confirm('¿Estás seguro?');">
                        ...
                        <?php else: ?>
                             <form method="post" action="IndexUsuarios-administrador.php?action=block" onsubmit="return confirm('¿Estás seguro?');">
                                <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($_SESSION['csrf_token'])?>">
                                <input type="hidden" name="id" value="<?= htmlspecialchars($usuario['id'], ENT_QUOTES) ?>">
