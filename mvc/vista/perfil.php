    ...
    <aside class="sidebar-perfil">
        ...
        <div class="contrasena-sidebar">
            ...
            <?php if (isset($_GET["pendiente_pass"])): ?>
                <p class="pendiente-info">Revisa tu email para confirmar el cambio de contraseña. El enlace caduca en 1 hora.</p>
            ...
            <form method="post" action="<?= $perfil_url ?>?action=solicitar_cambio_contrasena" class="form-editar">
                <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($_SESSION['csrf_token'])?>">
                <div class="form-grupo">
